...
<div id="content">
    ...
    // from
      //echo "<td><a href=\"view.php?id=".$row['Id']."\"> ". $row['T_Name'] ." </a></td>";
	   echo "<td>" . $row['T_Name'] . "</td>";
     
    // add more rows and change the name of row_name2 to whatever row/rows you 
    // want to show in the main page
      echo "<td>" . $row['Designation'] . "</td>";
	  echo "<td><a href=\"view.php?id=".$row['Id']."\"> View the schedule</a></td>";
	  echo "<td><a href=\"studentview.php?id=".$row['Id']."\"> view the profile </a></td>";
