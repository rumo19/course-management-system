...
<?php
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		if ($e=='0')
		{
			$sql="INSERT INTO info VALUES('$roll','$name','null','0','t',CURDATE(),CURTIME(),'$email','$phone',AES_ENCRYPT('$pass', '123'));";
...
<div id="main">
    ...
    <div id="content">
        ...
        <?php
            ...
            <form method="post" action="addteacher.php" name="add_s" enctype="multipart/form-data">
            	<table id="tbl">
                	<tr>
                    	<td>Name:</td>
