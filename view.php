...
if($t=='r')
{
	echo '<table id="tt">
			<tr><th>Course no</th>
			<th>Level</th> <th>Term</th> <th>Batch</th> <th>Section</th> <th>Day</th> <th>Room No</th> <th>Starting Time</th><th>Delete</th><th>Edit</th>';
}
else
echo '<table id="tt">
			<tr><th>Course no</th>
	...
	echo '<tr><td>';
							...
							if($t=='r')
							{
							 echo "<td><a href=\"edituser.php?ds=".$row['sid']."&id=".$row['T_Id']."\"> Delete schedule </a></td>";
							  echo "<td><a href=\"updateschedule.php?ds=".$row['sid']."&id=".$row['T_Id']."\"> Edit schedule </a></td>";
							}
							//echo '<br/>';
