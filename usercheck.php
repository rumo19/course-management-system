...
#registration-form {
    ...
    <?php
        if($_SERVER['REQUEST_METHOD'] == 'POST')
		{
            ...
            if ($e=='0'){
                 $sql="INSERT INTO info VALUES('$roll','$name','$batch','$section','s',CURDATE(),CURTIME(),'$email','$phone',AES_ENCRYPT('$pass', '123'),'1');";
                $ttt=mysql_query($sql);
            ...
            <div id="content">
				...
				if(isset($ttt))
				{
				 ...
				 ?>
                    ...
                    <form method="post" action="usercheck.php" name="add_s" enctype="multipart/form-data">
                        <table id="tbl">
                            <tr>
                                <td>Name:</td>
