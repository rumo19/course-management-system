...
<?php
	...
	$sql="(select * from info where type='t')";
	...
	while($row = mysql_fetch_array($result))
      ...
      echo "<td>" . $row['name'] . "</td>";
	    ...
	    echo "<td>" . $row['email'] . "</td>";
		 ...
		 echo "<td><a href=\"edituser.php?d=".$row['id']."\"> Delete User </a></td>";
		 if($row['isactive']=='0')
		 {
		 
		 echo "<td><a href=\"edituser.php?u=".$row['id']."\"> Unblock User </a></td>";
		 }
		 else
		 {
			 echo "<td><a href=\"edituser.php?b=".$row['id']."\"> block User </a></td>";
			 }
		 }
