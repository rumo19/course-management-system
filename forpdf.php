...
<div id="main">
    ...
    <div id="content">
    	<div id="log">
        	<p id="title">Make result sheet in pdf format</p>
            <hr align="left" width="100%">
            <form action="genpdf.php" method="get" name="v_rslt">
            <table id="tbl">
            ...
            <tr>
            	<td colspan="2" style="padding-left:140px;"><a  target="_blank" onclick="document.v_rslt.submit()" class="myButton">View</a></td>
            </tr>
            </table>
        </div>
    </div>
