...
<div id="main">
    ...
    <div id="content">
		...
		?>
        	<p id="title">Delete user</p>
            <hr align="left" width="100%">
        	<form action="updatebyid.php" method="post" name="log_frm">
            	<table id="tbl">
                	<tr>
                    	<td>Enter id:</td>
                    ...
                    <tr>
                    	<td colspan="2" style="padding-left:183px;"><a href="#" onclick="document.log_frm.submit()" class="myButton">delete</a>
                    </tr>
                </table>
            </form>
